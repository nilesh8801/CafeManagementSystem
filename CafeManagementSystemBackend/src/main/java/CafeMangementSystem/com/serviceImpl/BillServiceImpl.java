    ...
    public ResponseEntity<String> generateReport(Map<String, Object> requestMap) {
        ...
        try {
            ...
            if (validateRequestMap(requestMap)) {
                ...
                //we have to add data in to table- JSONarray through bcz our data JSON format
                   //getJsonArrayFromString - convert  string to JOSN Array
                JSONArray jsonArray = CafeUtils.getJsonArrayFromString((String) requestMap.get("productDetails"));
                //each iteration extract one JSON & add in row
                for (int i = 0; i < jsonArray.length(); i++) {
                    //write addRow method add Row in table
